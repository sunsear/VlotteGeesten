...
public class DeckStepDefinitions {
	...
	public void there_should_be_a_deck_of_different_valid_cards(
			int numberOfCards) {
		Deck deck = new Deck();
	...
	// public void
	// there_should_be_card_depicting_item1_and_item2_for_which_the_desired_item_is_item1(
	...
	// public void
	// there_should_be_at_least_card_depicting_item1_and_item2_for_which_the_desired_item_is_item3(
	// int numberOfCards, Item item1, Item item2, Item desiredItem) {
	// // Write code here that turns the phrase above into concrete actions
	// throw new PendingException();
	// }
