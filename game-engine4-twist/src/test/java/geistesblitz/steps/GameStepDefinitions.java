...
public class GameStepDefinitions {
    ...
    public void a_new_round_of_play_showing_a_card_with_a_and_a(Color colour, Item type, Color colour2, Item type2) {
    ...
    public void player_chooses_the(int playerNumber, Color colour, Item type) throws Throwable {
