Feature: Spicing up the card generation
  The correctly colored item is only shown on a card once with each other item
  ...
  It's up to you now to think of the examples.
